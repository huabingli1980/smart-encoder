...
public class SQLiteDialect extends Dialect
{
    public SQLiteDialect() {
        ...
        this.registerFunction("concat", (SQLFunction)new VarArgsSQLFunction((Type)StringType.INSTANCE, "", "||", ""));
        this.registerFunction("mod", (SQLFunction)new SQLFunctionTemplate((Type)StringType.INSTANCE, "?1 % ?2"));
        this.registerFunction("substr", (SQLFunction)new StandardSQLFunction("substr", (Type)StringType.INSTANCE));
        this.registerFunction("substring", (SQLFunction)new StandardSQLFunction("substr", (Type)StringType.INSTANCE));
    }
